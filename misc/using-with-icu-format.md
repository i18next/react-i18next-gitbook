...
To enable ICU format you will need to include the [i18next-icu](https://github.com/i18next/i18next-icu) module into your [i18next instance](../legacy/i18next-instance.md).
...
So the default option is to use the [Trans Component](../legacy/trans-component.md) just with props like:
